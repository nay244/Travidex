...
| Share gem §3.7 | ShareGem is a pushed page, not a bottom sheet over dimmed Community | Build notes 4.1: "page is workable, sheet is the spec" — same allowance as art picker | Sheet variant if requested | STANDING |
...
| Flags KR/CN/MX | KR taegeuk halves and trigrams omitted (red disc only); CN five-star cluster simplified to single gold disc; MX coat of arms omitted | DSL primitives only support solid circles/stripes; emblems require SVG assets | Custom flag art per country | STANDING |
